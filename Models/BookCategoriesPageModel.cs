...
namespace Petrut_Alexandru_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Petrut_Alexandru_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Petrut_Alexandru_Lab8Context context,
